  ...
  return (
    <div className="max-w-sm mx-auto mt-12">
      <div className="bg-white rounded-lg shadow p-8">
        <h1 className="text-xl font-bold text-gray-900 mb-1">Activate Your Account</h1>
        <p className="text-sm text-gray-500 mb-6">Choose a password to finish setting up your account.</p>

        {!token && (
          <p className="text-sm text-red-600">This invitation link is missing its token. Use the full link from your email.</p>
        )}

        {done ? (
          <div className="px-4 py-3 bg-green-50 border border-green-200 rounded text-sm text-green-800">
            Account activated! Redirecting… Use the lock icon to sign in.
          </div>
        ) : token && (
